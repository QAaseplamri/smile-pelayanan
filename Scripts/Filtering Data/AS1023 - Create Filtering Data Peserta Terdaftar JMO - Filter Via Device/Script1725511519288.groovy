...
WebUI.click(findTestObject('Filtering Data/Edit CMS/Page_SMILE - Sistem Informasi Perlindungan Pekerja (46)/b_Edit'))

WebUI.switchToWindowTitle('SMILE')

WebUI.takeScreenshot()

WebUI.click(findTestObject('Filtering Data/Edit CMS/Page_SMILE/android'))

WebUI.click(findTestObject('Filtering Data/Edit CMS/Page_SMILE/btn-tampilkan'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Filtering Data/Edit CMS/Page_SMILE/ios'))

WebUI.click(findTestObject('Filtering Data/Edit CMS/Page_SMILE/btn-tampilkan'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Filtering Data/Edit CMS/Page_SMILE/all'))
