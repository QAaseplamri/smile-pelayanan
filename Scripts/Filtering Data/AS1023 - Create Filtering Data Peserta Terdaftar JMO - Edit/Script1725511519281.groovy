...
WebUI.click(findTestObject('Filtering Data/Edit CMS/Page_SMILE/status_uncek'))
...
WebUI.setText(findTestObject('Filtering Data/Filtering Data/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/textarea__namaKriteria'), 
    'Testing data 1')
