...
String inisial = findTestData('Data Files/Pengajuan FAQ/data_role').getValue('inisial', 2)

String role = findTestData('Data Files/Pengajuan FAQ/data_role').getValue('role', 2)
...
not_run: WebUI.doubleClick(findTestObject('Konten faq/Pengajuan FAQ/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_e-Channel'))
...
not_run: WebUI.scrollToElement(findTestObject('Konten faq/Pengajuan FAQ/Page_SMILE - Sistem Informasi Perlindungan Pekerja (46)/span_AS1034- Approval Pengajuan Penyesuaian CMS FAQ'), 
    0)

not_run: WebUI.doubleClick(findTestObject('Konten faq/Pengajuan FAQ/Page_SMILE - Sistem Informasi Perlindungan Pekerja (46)/span_AS1034- Approval Pengajuan Penyesuaian CMS FAQ'))
...
WebUI.click(findTestObject('Konten faq/Pengajuan FAQ/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/input_status_tolak'))
