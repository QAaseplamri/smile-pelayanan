...
String inisial = findTestData('Data Files/Pengajuan FAQ/data_role').getValue('inisial', 3)

String role = findTestData('Data Files/Pengajuan FAQ/data_role').getValue('role', 3)
...
WebUI.callTestCase(findTestCase('Konten FAQ/Pengajuan FAQ/FAQ005 - Cek status - PPMF - Petugas Pengelola CMS FAQ ( 0 )'), 
    [:], FailureHandling.STOP_ON_FAILURE)
