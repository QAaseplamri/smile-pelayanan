...
WebUI.click(findTestObject('Object Repository/Blasting Campaign/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/button_Submit'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Object Repository/Blasting Campaign/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_Yes_button-1006-btnIconEl'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Object Repository/Blasting Campaign/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_OK_button-1005-btnIconEl'))
