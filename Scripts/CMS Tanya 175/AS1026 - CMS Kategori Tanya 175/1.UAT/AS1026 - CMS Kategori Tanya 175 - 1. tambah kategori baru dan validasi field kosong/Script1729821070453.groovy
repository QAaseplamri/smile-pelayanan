...
WebUI.click(findTestObject('Object Repository/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_AS1026- CMS Kategori Tanya 175'))

WebUI.click(findTestObject('Object Repository/175/validasi as1026/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_New'))

WebUI.click(findTestObject('Object Repository/175/validasi as1026/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/button_Simpan'))

WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshoot/175/validasi-kategori.png')

WebUI.click(findTestObject('Object Repository/175/validasi as1026/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_OK_button-1005-btnIconEl'))

WebUI.setText(findTestObject('Object Repository/175/validasi as1026/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/input__nama_kategori'), 
    'VIDEO DAN DOK TESTING')

WebUI.click(findTestObject('Object Repository/175/validasi as1026/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/button_Simpan'))

WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshoot/175/validasi-ket-kategori.png')

WebUI.click(findTestObject('Object Repository/175/validasi as1026/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_OK_button-1005-btnIconEl'))

WebUI.setText(findTestObject('Object Repository/175/validasi as1026/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/textarea__keterangan_kategori'), 
    'KET VIDEO DAN DOK TESTING')

WebUI.click(findTestObject('Object Repository/175/validasi as1026/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/button_Simpan'))

WebUI.click(findTestObject('Object Repository/175/validasi as1026/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_Yes_button-1006-btnIconEl'))

WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshoot/175/new-sukses.png')
