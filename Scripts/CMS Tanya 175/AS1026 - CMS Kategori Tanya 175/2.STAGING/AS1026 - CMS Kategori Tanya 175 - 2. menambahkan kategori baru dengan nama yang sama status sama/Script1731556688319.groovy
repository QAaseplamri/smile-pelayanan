...
WebUI.click(findTestObject('Object Repository/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/a_New'))

WebUI.setText(findTestObject('Object Repository/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/input__nama_kategori'), 
    'VIDEO DAN DOK TESTING')

WebUI.setText(findTestObject('Object Repository/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/textarea__keterangan_kategori'), 
    'KETERANGAN VIDEO DAN DOK TESTING')

WebUI.click(findTestObject('Object Repository/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/button_Simpan'))

WebUI.click(findTestObject('Object Repository/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_Yes_button-1006-btnIconEl'))

WebUI.takeScreenshot(RunConfiguration.getProjectDir() + '/Screenshoot/175/validasi_nama_sama.png')

WebUI.click(findTestObject('Object Repository/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/span_OK_button-1005-btnIconEl'))
