...
WebUI.click(findTestObject('Object Repository/beasiswa/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/input_Manfaat Beasiswa JKK_tipe_manfaat'))
...
WebUI.setText(findTestObject('Object Repository/beasiswa/Page_SIJSTK/input_Search By_searchtxt'), '7602140310700002')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/beasiswa/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/select_-- Pilih Jenis Penerima Manfaat --  _efcf89'), 
    'Y', true)
...
WebUI.setText(findTestObject('beasiswa/Page_SMILE - Sistem Informasi Perlindungan _1e51ce/input_Email_email_pelapor'), 'BEASISWA0022@GMAIL.COM')
